...
# --- INTERFACE GRAPHIQUE ---
class TrainingGUI:
    def __init__(self, timeWindow=2.0):
        pygame.init()
    ...
    def generate_separate_viz(self, clf, X, y, y_pred, y_proba, class_names):
        ...
        file_matrix = os.path.join(RESULTS_DIR, f"confusion_matrix_{self.windowTime}_{timestamp}.png")
        ...
        try:
            ...
            file_pca = os.path.join(RESULTS_DIR, f"pca_zones_{self.windowTime}_{timestamp}.png")
        ...
        if len(class_names) == 3:
            ...
            file_tri = os.path.join(RESULTS_DIR, f"triangle_{self.windowTime}_{timestamp}.png")
...
if __name__ == "__main__":
    app = TrainingGUI(timeWindow=2.75)
    app.run()