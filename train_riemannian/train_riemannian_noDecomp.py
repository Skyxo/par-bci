...
class TrainingGUI:
    ...
    def generate_separate_viz(self, clf, X, y, y_pred, y_proba, class_names):
        ...
        file_matrix = os.path.join(RESULTS_DIR, f"confusion_matrix_{timestamp}.png")
        ...
        try:
            ...
            file_pca = os.path.join(RESULTS_DIR, f"pca_zones_{timestamp}.png")
        ...
        if len(class_names) == 3:
            ...
            file_tri = os.path.join(RESULTS_DIR, f"triangle_{timestamp}.png")
    ...
    def run_training(self):
        ...
        try:
            ...
            window_duration = 2.0  # Durée de chaque analyse (s)
        ...
        try:
            ...
            clf = make_pipeline(feat_logvar, StandardScaler(), LogisticRegression(solver='lbfgs', max_iter=2000, class_weight='balanced'))
